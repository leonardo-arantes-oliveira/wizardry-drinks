import {menuLeafs,menuArrows} from '../../../data/menuData'
...
gsap.fromTo('.details p',{opacity:0,yPercent:100},{opacity:1,yPercent:0,duration:1,ease:'power1.inOut',delay:0.5})
...
return (
    <section id="menu" aria-labelledby="menu-heading">
        <img src={menuLeafs.mLeftLeaf
        } alt="left-leaf" id='m-left-leaf' />
        <img src={menuLeafs.mRightLeaf} alt="right-leaf" id='m-right-leaf' />
        <h2 id='menu-heading' className='sr-only'>Cardápio</h2>
