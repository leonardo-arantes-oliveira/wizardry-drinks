    ...
    <div id="art">
        <div className="container mx-auto h-full pt-20">
            ...
            <div className='masked-container'>
                <h2 className='will-fade'>Perfeição a Cada Gole</h2>
                <div id='masked-content'>
                    <h3>Feito com Criatividade,Servido com Paixão</h3>
                    <p>Não é apenas uma bebida.é um momento especial criado especialmente para você</p>
                </div>
            </div>
        </div>
    </div>
